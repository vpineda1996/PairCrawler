...
public class HistogramScene {
    final static int PERCENTAGES[] = {0, 15, 25, 35, 45,
            55, 65, 77, 86, 100};

    private AreaChart<Number,Number> bc;
    ...
    public void setupChart(final AnchorPane anchorPane) {
        final NumberAxis xAxis = new NumberAxis(0d,100d,10d);
        final NumberAxis yAxis = new NumberAxis();

        // Create a new chart and customize it
        this.bc = new CustomAreaChart(xAxis, yAxis);

        // Customization
        AnchorPane.setTopAnchor(bc, 0d);
        AnchorPane.setLeftAnchor(bc, 0d);
        AnchorPane.setRightAnchor(bc, 0d);
        AnchorPane.setBottomAnchor(bc, 0d);


        this.bc.setTitle("Grades Distribution");
        ...
        // Attach to the sent anchor pane the cool modified chart
    ...
    public void updateGraph(Collection<? extends Section> sections){
        ...
        for(Section s : sections){
            ...
            for(Integer grade : s.getGrades()){
                series.getData().add(new XYChart.Data<Integer,Integer>(PERCENTAGES[i++],grade));
            }
    ...
    public static class CustomAreaChart extends AreaChart<Number,Number>{

        /**
         * All of this class has been copied from Jasper Potts. Thank you so much for your project in
         * http://fxexperience.com/2012/01/curve-fitting-and-styling-areachart/ it was really helpful
         * @param xAxis
         * @param yAxis
         */

        public CustomAreaChart(NumberAxis xAxis, NumberAxis yAxis) {
            super(xAxis, yAxis);
        }
